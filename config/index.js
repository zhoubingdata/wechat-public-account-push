...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx1d0a51916bb0030f',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'bc8a75bfbe743218682791e78015e996',
  ...
  USERS: [
    {
      ...
      id: 'o9qoy6TvwE0cggKct4_PpvwmVUsw',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'anRTcIKdX_7iPjrLN6X9bi6WuDiQnsy0TRYEOqoYB9A',
      // 所在省份
      province: '广东',
      // 所在城市
      city: '肇庆',
